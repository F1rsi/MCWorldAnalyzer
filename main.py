...
def main(args):
    ...
    for region_file_name in unused_region_file_names:
        ...
        block_acacia_fence = 0                   # Генерация
        block_acacia_leaves = 0                  # Генерация
        block_acacia_log = 0                     # Генерация
        block_acacia_planks = 0                  # Генерация
        block_acacia_stairs = 0                  # Генерация
        block_air = 0                            # Генерация
        block_allium = 0                         # Генерация
        block_andesite = 0                       # Генерация
        block_bed = 0                            # Генерация
        block_bedrock = 0                        # Генерация
        block_beetroots = 0                      # Генерация
        block_birch_fence = 0                    # Генерация
        block_birch_leaves = 0                   # Генерация
        block_birch_log = 0                      # Генерация
        block_birch_planks = 0                   # Генерация
        block_birch_slab = 0                     # Генерация
        block_birch_stairs = 0                   # Генерация
        block_black_wool = 0                     # Генерация
        block_blue_orchid = 0                    # Генерация
        block_blue_terracotta = 0                # Генерация
        block_blue_wool = 0                      # Генерация
        block_bone_block = 0                     # Генерация
        block_bookshelf = 0                      # Генерация
        block_brewing_stand = 0                  # Генерация
        block_brown_mushroom = 0                 # Генерация
        block_brown_mushroom_block = 0           # Генерация
        block_brown_terracotta = 0               # Генерация
        block_brown_wool = 0                     # Генерация
        block_cactus = 0                         # Генерация
        block_carrots = 0                        # Генерация
        block_carved_pumpkin = 0                 # Генерация
        block_cauldron = 0                       # Генерация
        block_chest = 0                          # Генерация
        block_chiseled_stone_bricks = 0          # Генерация
        block_clay = 0                           # Генерация
        block_coal_ore = 0                       # Генерация
        block_coarse_dirt = 0                    # Генерация
        block_cobblestone = 0                    # Генерация
        block_cobblestone_slab = 0               # Генерация
        block_cobblestone_stairs = 0             # Генерация
        block_cobblestone_wall = 0               # Генерация
        block_cobweb = 0                         # Генерация
        block_cocoa = 0                          # Генерация
        block_cracked_stone_bricks = 0           # Генерация
        block_crafting_table = 0                 # Генерация
        block_cyan_wool = 0                      # Генерация
        block_dandelion = 0                      # Генерация
        block_dark_oak_fence = 0                 # Генерация
        block_dark_oak_fence_gate = 0            # Генерация
        block_dark_oak_leaves = 0                # Генерация
        block_dark_oak_log = 0                   # Генерация
        block_dark_oak_planks = 0                # Генерация
        block_dark_oak_sapling = 0               # Генерация
        block_dark_oak_stairs = 0                # Генерация
        block_dark_prismarine = 0                # Генерация
        block_dead_bush = 0                      # Генерация
        block_dead_shrub = 0                     # Генерация
        block_diamond_block = 0                  # Генерация
        block_diamond_ore = 0                    # Генерация
        block_diorite = 0                        # Генерация
        block_dirt = 0                           # Генерация
        block_dispenser = 0                      # Генерация
        block_emerald_ore = 0                    # Генерация
        block_end_portal_frame = 0               # Генерация
        block_farmland = 0                       # Генерация
        block_fern = 0                           # Генерация
        block_flower_pot = 0                     # Генерация
        block_furnace = 0                        # Генерация
        block_glass = 0                          # Генерация
        block_glass_pane = 0                     # Генерация
        block_gold_ore = 0                       # Генерация
        block_granite = 0                        # Генерация
        block_grass = 0                          # Генерация
        block_grass_block = 0                    # Генерация
        block_grass_path = 0                     # Генерация
        block_gravel = 0                         # Генерация
        ...
        block_infested_stone = 0                 # Генерация
        block_infested_stone_bricks = 0          # Генерация
        block_iron_bars = 0                      # Генерация
        block_iron_door = 0                      # Генерация
        block_iron_ore = 0                       # Генерация
        block_jungle_leaves = 0                  # Генерация
        block_jungle_log = 0                     # Генерация
        block_ladder = 0                         # Генерация
        block_lapis_block = 0                    # Генерация
        block_lapis_ore = 0                      # Генерация
        block_large_fern = 0                     # Генерация
        block_lava = 0                           # Генерация
        block_lever = 0                          # Генерация
        block_light_blue_wool = 0                # Генерация
        block_light_gray_terracotta = 0          # Генерация
        block_light_gray_wool = 0                # Генерация
        block_lilac = 0                          # Генерация
        block_lily_pad = 0                       # Генерация
        block_lime_wool = 0                      # Генерация
        block_melon = 0                          # Генерация
        block_melon_stem = 0                     # Генерация
        block_mossy_cobblestone = 0              # Генерация
        block_mossy_cobblestone_wall = 0         # 
        block_mossy_stone_bricks = 0             # Генерация
        block_mycelium = 0                       # Генерация
        block_oak_door = 0                       # Генерация
        block_oak_fence = 0                      # Генерация
        block_oak_leaves = 0                     # Генерация
        block_oak_log = 0                        # Генерация
        block_oak_planks = 0                     # Генерация
        block_oak_pressure_plate = 0             # Генерация
        block_oak_sign = 0                       # Генерация
        block_oak_slab = 0                       # Генерация 
        block_oak_stairs = 0                     # Генерация
        block_oak_trapdoor = 0                   # Генерация
        block_obsidian = 0                       # Генерация
        block_orange_terracotta = 0              # Генерация
        block_orange_tulip = 0                   # Генерация
        block_orange_wool = 0                    # Генерация
        block_oxeye_daise = 0                    # Генерация
        block_packed_ice = 0                     # Генерация
        block_peony = 0                          # Генерация
        block_pink_tulip = 0                     # Генерация
        block_podzol = 0                         # Генерация
        block_polished_andesite = 0              # Генерация
        block_poppy = 0                          # Генерация
        block_potatoes = 0                       # Генерация
        block_potted_acacia_sapling = 0          # 
        block_potted_birch_sapling = 0           # 
        block_potted_brown_mushroom = 0          # 
        block_potted_cactus = 0                  # 
        block_potted_dandelion = 0               # Генерация
        ...
        block_prismarine = 0                     # Генерация
        block_prismarine_bricks = 0              # Генерация
        block_pumpkin_stem = 0                   # Генерация
        block_rail = 0                           # Генерация
        block_red_mushroom = 0                   # Генерация
        block_red_mushroom_block = 0             # Генерация
        block_red_sand = 0                       # Генерация
        block_red_sandstone = 0                  # Генерация
        block_red_sandstone_slab = 0             # Крафт?
        block_red_sandstone_stairs = 0           # Крафт?
        block_red_terracotta = 0                 # Генерация
        block_red_tulip = 0                      # Генерация
        block_red_wool = 0                       # Генерация
        block_redstone_ore = 0                   # Генерация
        block_redstone_torch = 0                 # Генерация
        block_redstone_wire = 0                  # Генерация
        block_repeater = 0                       # Генерация
        block_rose_bush = 0                      # Генерация
        block_sand = 0                           # Генерация
        block_sandstone = 0                      # Генерация
        block_sandstone_slab = 0                 # Генерация
        block_sandstone_stairs = 0               # Крафт?
        block_sea_lantern = 0                    # Генерация
        block_smooth_sandstone = 0               # ?
        block_smooth_stone = 0                   # ?
        block_smooth_stone_slab = 0              # Генерация
        block_snow = 0                           # Генерация
        block_snow_block = 0                     # Генерация
        block_spawner = 0                        # Генерация
        block_spruce_fence = 0                   # Генерация
        block_spruce_leaves = 0                  # Генерация
        block_spruce_log = 0                     # Генерация
        block_spruce_planks = 0                  # Генерация
        block_spruce_slab = 0                    # Генерация
        block_spruce_stairs = 0                  # Генерация
        block_stone = 0                          # Генерация
        block_stone_brick_stairs = 0             # Генерация
        block_stone_bricks = 0                   # Генерация
        block_stone_button = 0                   # Генерация
        block_stone_pressure_plate = 0           # Генерация
        block_sugar_cane = 0                     # Генерация
        block_sunflower = 0                      # Генерация
        block_tall_grass = 0                     # Генерация
        block_terracotta = 0                     # Генерация
        block_tnt = 0                            # Генерация
        block_torch = 0                          # Генерация
        block_trapped_chest = 0                  # Генерация
        block_tripwire = 0                       # Генерация
        block_tripwire_hook = 0                  # Генерация
        block_vine = 0                           # Генерация
        block_water = 0                          # Генерация
        block_wet_sponge = 0                     # Генерация
        block_wheat = 0                          # Генерация
        block_white_terracotta = 0               # Генерация
        block_white_tulip = 0                    # Генерация
        block_white_wool = 0                     # Генерация
        block_wooden_slab = 0                    # ?
        block_yellow_terracotta = 0              # Генерация
        block_yellow_wool = 0                    # Генерация
        block_azure_bluet = 0                    # Генерация

        block_white_carpet = 0                   # Генерация
        block_orange_carpet = 0                  # 
        block_magenta_carpet = 0                 # Генерация
        block_light_blue_carpet = 0              # 
        block_yellow_carpet = 0                  # Генерация
        block_lime_carpet = 0                    # Генерация
        block_pink_carpet = 0                    # Генерация
        block_gray_carpet = 0                    # Генерация
        block_light_gray_carpet = 0              # Генерация
        block_cyan_carpet = 0                    # 
        block_purple_carpet = 0                  # Генерация
        block_blue_carpet = 0                    # Генерация
        block_brown_carpet = 0                   # Генерация
        block_green_carpet = 0                   # Генерация
        block_red_carpet = 0                     # Генерация
        block_black_carpet = 0                   # Генерация
