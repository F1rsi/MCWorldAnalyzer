...
def main(args):
    ...
    for region_file_name in unused_region_file_names:
        ...
        with open(concatenate_paths(OUTPUT_FOLDER, region_file_name), 'w') as f:
            f.write('{block_acacia_door=}\n')
            f.write('{block_acacia_fence=}\n')
            f.write('{block_acacia_leaves=}\n')
            f.write('{block_acacia_log=}\n')
            f.write('{block_acacia_planks=}\n')
            f.write('{block_acacia_stairs=}\n')
            f.write('{block_air=}\n')
            f.write('{block_allium=}\n')
            f.write('{block_andesite=}\n')
            f.write('{block_azure_bluet=}\n')
            f.write('{block_bed=}\n')
            f.write('{block_bedrock=}\n')
            f.write('{block_beetroots=}\n')
            f.write('{block_birch_fence=}\n')
            f.write('{block_birch_leaves=}\n')
            f.write('{block_birch_log=}\n')
            f.write('{block_birch_planks=}\n')
            f.write('{block_birch_slab=}\n')
            f.write('{block_birch_stairs=}\n')
            f.write('{block_black_carpet=}\n')
            f.write('{block_black_wool=}\n')
            f.write('{block_blue_carpet=}\n')
            f.write('{block_blue_orchid=}\n')
            f.write('{block_blue_terracotta=}\n')
            f.write('{block_blue_wool=}\n')
            f.write('{block_bone_block=}\n')
            f.write('{block_bookshelf=}\n')
            f.write('{block_brewing_stand=}\n')
            f.write('{block_brown_carpet=}\n')
            f.write('{block_brown_mushroom=}\n')
            f.write('{block_brown_mushroom_block=}\n')
            f.write('{block_brown_terracotta=}\n')
            f.write('{block_brown_wool=}\n')
            f.write('{block_cactus=}\n')
            f.write('{block_carrots=}\n')
            f.write('{block_carved_pumpkin=}\n')
            f.write('{block_cauldron=}\n')
            f.write('{block_chest=}\n')
            f.write('{block_chiseled_stone_bricks=}\n')
            f.write('{block_clay=}\n')
            f.write('{block_coal_ore=}\n')
            f.write('{block_coarse_dirt=}\n')
            f.write('{block_cobblestone=}\n')
            f.write('{block_cobblestone_slab=}\n')
            f.write('{block_cobblestone_stairs=}\n')
            f.write('{block_cobblestone_wall=}\n')
            f.write('{block_cobweb=}\n')
            f.write('{block_cocoa=}\n')
            f.write('{block_cracked_stone_bricks=}\n')
            f.write('{block_crafting_table=}\n')
            f.write('{block_cyan_carpet=}\n')
            f.write('{block_cyan_wool=}\n')
            f.write('{block_dandelion=}\n')
            f.write('{block_dark_oak_fence=}\n')
            f.write('{block_dark_oak_fence_gate=}\n')
            f.write('{block_dark_oak_leaves=}\n')
            f.write('{block_dark_oak_log=}\n')
            f.write('{block_dark_oak_planks=}\n')
            f.write('{block_dark_oak_sapling=}\n')
            f.write('{block_dark_oak_stairs=}\n')
            f.write('{block_dark_prismarine=}\n')
            f.write('{block_dead_bush=}\n')
            f.write('{block_dead_shrub=}\n')
            f.write('{block_diamond_block=}\n')
            f.write('{block_diamond_ore=}\n')
            f.write('{block_diorite=}\n')
            f.write('{block_dirt=}\n')
            f.write('{block_dispenser=}\n')
            f.write('{block_emerald_ore=}\n')
            f.write('{block_end_portal_frame=}\n')
            f.write('{block_farmland=}\n')
            f.write('{block_fern=}\n')
            f.write('{block_flower_pot=}\n')
            f.write('{block_furnace=}\n')
            f.write('{block_glass=}\n')
            f.write('{block_glass_pane=}\n')
            f.write('{block_gold_ore=}\n')
            f.write('{block_granite=}\n')
            f.write('{block_grass=}\n')
            f.write('{block_grass_block=}\n')
            f.write('{block_grass_path=}\n')
            f.write('{block_gravel=}\n')
            f.write('{block_gray_carpet=}\n')
            f.write('{block_gray_wool=}\n')
            f.write('{block_green_carpet=}\n')
            f.write('{block_green_wool=}\n')
            f.write('{block_ice=}\n')
            f.write('{block_infested_chiseled_stone_bricks=}\n')
            f.write('{block_infested_cobblestone=}\n')
            f.write('{block_infested_cracked_stone_bricks=}\n')
            f.write('{block_infested_mossy_stone_bricks=}\n')
            f.write('{block_infested_stone=}\n')
            f.write('{block_infested_stone_bricks=}\n')
            f.write('{block_iron_bars=}\n')
            f.write('{block_iron_door=}\n')
            f.write('{block_iron_ore=}\n')
            f.write('{block_jungle_leaves=}\n')
            f.write('{block_jungle_log=}\n')
            f.write('{block_ladder=}\n')
            f.write('{block_lapis_block=}\n')
            f.write('{block_lapis_ore=}\n')
            f.write('{block_large_fern=}\n')
            f.write('{block_lava=}\n')
            f.write('{block_lever=}\n')
            f.write('{block_light_blue_carpet=}\n')
            f.write('{block_light_blue_wool=}\n')
            f.write('{block_light_gray_carpet=}\n')
            f.write('{block_light_gray_terracotta=}\n')
            f.write('{block_light_gray_wool=}\n')
            f.write('{block_lilac=}\n')
            f.write('{block_lily_pad=}\n')
            f.write('{block_lime_carpet=}\n')
            f.write('{block_lime_wool=}\n')
            f.write('{block_magenta_carpet=}\n')
            f.write('{block_melon=}\n')
            f.write('{block_melon_stem=}\n')
            f.write('{block_mossy_cobblestone=}\n')
            f.write('{block_mossy_cobblestone_wall=}\n')
            f.write('{block_mossy_stone_bricks=}\n')
            f.write('{block_mycelium=}\n')
            f.write('{block_oak_door=}\n')
            f.write('{block_oak_fence=}\n')
            f.write('{block_oak_leaves=}\n')
            f.write('{block_oak_log=}\n')
            f.write('{block_oak_planks=}\n')
            f.write('{block_oak_pressure_plate=}\n')
            f.write('{block_oak_sign=}\n')
            f.write('{block_oak_slab=}\n')
            f.write('{block_oak_stairs=}\n')
            f.write('{block_oak_trapdoor=}\n')
            f.write('{block_obsidian=}\n')
            f.write('{block_orange_carpet=}\n')
            f.write('{block_orange_terracotta=}\n')
            f.write('{block_orange_tulip=}\n')
            f.write('{block_orange_wool=}\n')
            f.write('{block_oxeye_daise=}\n')
            f.write('{block_packed_ice=}\n')
            f.write('{block_peony=}\n')
            f.write('{block_pink_carpet=}\n')
            f.write('{block_pink_tulip=}\n')
            f.write('{block_podzol=}\n')
            f.write('{block_polished_andesite=}\n')
            f.write('{block_poppy=}\n')
            f.write('{block_potatoes=}\n')
            f.write('{block_potted_acacia_sapling=}\n')
            f.write('{block_potted_birch_sapling=}\n')
            f.write('{block_potted_brown_mushroom=}\n')
            f.write('{block_potted_cactus=}\n')
            f.write('{block_potted_dandelion=}\n')
            f.write('{block_potted_dark_oak_sapling=}\n')
            f.write('{block_potted_dead_bush=}\n')
            f.write('{block_potted_fern=}\n')
            f.write('{block_potted_jungle_sapling=}\n')
            f.write('{block_potted_oak_sapling=}\n')
            f.write('{block_potted_poppy=}\n')
            f.write('{block_potted_red_mushroom=}\n')
            f.write('{block_potted_spruce_sapling=}\n')
            f.write('{block_prismarine=}\n')
            f.write('{block_prismarine_bricks=}\n')
            f.write('{block_pumpkin_stem=}\n')
            f.write('{block_purple_carpet=}\n')
            f.write('{block_rail=}\n')
            f.write('{block_red_carpet=}\n')
            f.write('{block_red_mushroom=}\n')
            f.write('{block_red_mushroom_block=}\n')
            f.write('{block_red_sand=}\n')
            f.write('{block_red_sandstone=}\n')
            f.write('{block_red_sandstone_slab=}\n')
            f.write('{block_red_sandstone_stairs=}\n')
            f.write('{block_red_terracotta=}\n')
            f.write('{block_red_tulip=}\n')
            f.write('{block_red_wool=}\n')
            f.write('{block_redstone_ore=}\n')
            f.write('{block_redstone_torch=}\n')
            f.write('{block_redstone_wire=}\n')
            f.write('{block_repeater=}\n')
            f.write('{block_rose_bush=}\n')
            f.write('{block_sand=}\n')
            f.write('{block_sandstone=}\n')
            f.write('{block_sandstone_slab=}\n')
            f.write('{block_sandstone_stairs=}\n')
            f.write('{block_sea_lantern=}\n')
            f.write('{block_smooth_sandstone=}\n')
            f.write('{block_smooth_stone=}\n')
            f.write('{block_smooth_stone_slab=}\n')
            f.write('{block_snow=}\n')
            f.write('{block_snow_block=}\n')
            f.write('{block_spawner=}\n')
            f.write('{block_spruce_fence=}\n')
            f.write('{block_spruce_leaves=}\n')
            f.write('{block_spruce_log=}\n')
            f.write('{block_spruce_planks=}\n')
            f.write('{block_spruce_slab=}\n')
            f.write('{block_spruce_stairs=}\n')
            f.write('{block_stone=}\n')
            f.write('{block_stone_brick_stairs=}\n')
            f.write('{block_stone_bricks=}\n')
            f.write('{block_stone_button=}\n')
            f.write('{block_stone_pressure_plate=}\n')
            f.write('{block_sugar_cane=}\n')
            f.write('{block_sunflower=}\n')
            f.write('{block_tall_grass=}\n')
            f.write('{block_terracotta=}\n')
            f.write('{block_tnt=}\n')
            f.write('{block_torch=}\n')
            f.write('{block_trapped_chest=}\n')
            f.write('{block_tripwire=}\n')
            f.write('{block_tripwire_hook=}\n')
            f.write('{block_vine=}\n')
            f.write('{block_water=}\n')
            f.write('{block_wet_sponge=}\n')
            f.write('{block_wheat=}\n')
            f.write('{block_white_carpet=}\n')
            f.write('{block_white_terracotta=}\n')
            f.write('{block_white_tulip=}\n')
            f.write('{block_white_wool=}\n')
            f.write('{block_wooden_slab=}\n')
            f.write('{block_yellow_carpet=}\n')
            f.write('{block_yellow_terracotta=}\n')
            f.write('{block_yellow_wool=}')
